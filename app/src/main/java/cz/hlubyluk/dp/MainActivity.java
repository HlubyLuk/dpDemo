...
public class MainActivity extends ActionBarActivity implements IClickedButton {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            fragmentTransaction.replace(R.id.dlCont, FragmentHome.NewInstance());
            fragmentTransaction.replace(R.id.dlNavi, FragmentNavigation.newInstance());
    ...
    public void clicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.mdBT1:
                fragmentTransaction.replace(R.id.dlCont, FragmentOtherUI.newInstanc(((Button) view).getText()));
                break;
            case R.id.mdBT2:
                fragmentTransaction.replace(R.id.dlCont, FragmentOtherUI.newInstanc(((Button) view).getText()));
                break;
